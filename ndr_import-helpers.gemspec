...
Gem::Specification.new do |spec|
  spec.name          = 'ndr_import-helpers'
  spec.version       = NdrImport::Helpers::VERSION
  spec.authors       = ['NCRS Development Team']
  spec.email         = []
  spec.summary       = 'NDR Import Legacy Helpers'
  spec.description   = 'NDR ETL Importer Legacy File Helpers'
  spec.homepage      = 'https://github.com/NHSDigital/ndr_import-helpers'
  spec.license       = 'MIT'
